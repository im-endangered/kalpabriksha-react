        ...
        <div className="container">
          <div className="row">
            <div className="col-md-6 about-text">
              ...
              <p>
                Kalpabriksha is a development platform that aims to provide growth and support to youth in Nepalese societies through various traditional as well as experimental initiatives. We come up with different plans and programs that promote the emotional, intellectual, and social growth of students and the community they live in. Embracing the principle of equity, inclusion, and youth innovation, thisplatform envisions becoming a change that makes a difference and stands for a cause. We focus on collecting youth voices on different communal issues and working together to achieve collective success. Kalpabriksha connects bright Nepalese students from all over the country to collaborate on projects that spark a positive change in their community and in the larger scope, the country itself.
              </p>
              <p>
